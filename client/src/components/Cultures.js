...
<Link to='/Culture'>Welcome to the World of Cultures: Exploring Diversity and Traditions
    ...
    <div className="container mx-auto">
        ...
        <Slider>
          ...
          <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
            <Link to='/Culture' className="lg:text-xl leading-4 text-base lg:leading-5 text-white">
        China
            </Link>
        ...
        <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">
          ...
          />
          <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
            <Link to='/Culture' className="texlg:t-xl le leading-4 text-basealg:ding-tight text-white">
        Japan
            </Link>
            <div className="flex h-full items-end pb-6">
        <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">
