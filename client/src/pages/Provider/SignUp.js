...
function SignUp() {
  ...
  const backgroundImageUrl =
    "https://img.freepik.com/free-vector/worldwide-connection-gray-background-illustration-vector_53876-61769.jpg?size=626&ext=jpg&ga=GA1.1.558610342.1683500202&semt=ais";

  return (
    <>
      <div
        className="bg-cover bg-center  p-5 w-full   bg-white shadow sm:rounded-lg flex lg:flex-row flex-col justify-around items-center"
